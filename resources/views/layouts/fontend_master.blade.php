            ...
            <div class="row justify-content-between">
                <div class="col-sm-6 col-md-4 col-xl-3">
                    <div class="single-footer-widget footer_1">
                        <a href="index.html"> <img src="{{ asset('fontend') }}/img/footer_logo.png" alt=""> </a>
                ...
                <div class="col-xl-3 col-sm-6 col-md-4">
                    <div class="single-footer-widget footer_2">
                        ...
                        <div class="footer_img">
                            <a href="#"><img src="{{ asset('fontend') }}/img/footer_img/footer_1.png" alt=""></a>
                            <a href="#"><img src="{{ asset('fontend') }}/img/footer_img/footer_2.png" alt=""></a>
                            <a href="#"><img src="{{ asset('fontend') }}/img/footer_img/footer_3.png" alt=""></a>
                            <a href="#"><img src="{{ asset('fontend') }}/img/footer_img/footer_4.png" alt=""></a>
                            <a href="#"><img src="{{ asset('fontend') }}/img/footer_img/footer_5.png" alt=""></a>
                            <a href="#"><img src="{{ asset('fontend') }}/img/footer_img/footer_6.png" alt=""></a>
                            <a href="#"><img src="{{ asset('fontend') }}/img/footer_img/footer_7.png" alt=""></a>
                            <a href="#"><img src="{{ asset('fontend') }}/img/footer_img/footer_8.png" alt=""></a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-sm-6 col-md-4">
